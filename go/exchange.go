...
var tmpl = template.Must(template.ParseGlob("../template/*.html"))
...
// Line ... JSONに入ってくる線路の情報をtypeとして定義している。このJSON
...
// TransitNetwork ... http://fantasy-transit.appspot.com/net?format=json
// の一番外側のリストのことを表しています。
